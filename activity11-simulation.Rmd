...
*Response:* Mean of 50.19228 and Standard Deviation of 9.59245.
...
norm_samp_30 %>% 
  summarise(std=sd(values), mean=mean(values))
```
*Response:* Mean of 47.78609 and Standard Deviation of 9.87055
...
*Response:* The 1000 sample has a standard deviation of 49.58728 and mean of 48.31007, whereas the 30 sample has a standard deviation of 34.89176 and mean of 36.54428. The larger sample is much closer to the distribution mean/std of 50.
...
sample_mean(multi_sample_1000)
sample_mean(multi_sample_30)
```
...
*Response:* For the normal and uniform distributions the 30 sample is closer, but for the other two the 1000 sample is much closer. 
...
```{r}
map(multiple_samples, sample_mean(multiple_samples)) # Doesnt work yet
```
